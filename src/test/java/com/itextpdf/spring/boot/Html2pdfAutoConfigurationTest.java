...
/**
 * Unit tests for {{ @link Html2pdfAutoConfiguration }}.
 *
 ...
 * @since 1.0.0
 */
@DisplayName("Html2pdfAutoConfiguration Tests")
class Html2pdfAutoConfigurationTest {
    ...
    void testInstantiation() {
        Html2pdfAutoConfiguration configuration = new Html2pdfAutoConfiguration();
        assertThat(configuration).isNotNull();
    }

    @Test
    @DisplayName("Auto-configuration loads when 'spring.itext.html2pdf.enabled=true'")
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(Html2pdfAutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(Html2pdfAutoConfiguration.class));
    }
}
